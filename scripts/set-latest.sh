...
ALL_PACKAGES=(core dsl effect json signals react zustand store redux tanstack-form tanstack-store zod reads write drizzle devtools testing pinia vuex eslint-plugin solid async)
DRY_RUN=false
MODE=""
VERSION=""
EXPLICIT=()
...
_all_tags=$(git tag --list 'v*' --sort=-version:refname)
