...
ALL_PACKAGES=(core dsl effect json signals react zustand store redux tanstack-store zod reads write drizzle devtools testing pinia vuex eslint-plugin solid)
DRY_RUN=false
MODE=""
VERSION=""
EXPLICIT=()
