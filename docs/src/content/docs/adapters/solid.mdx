...
If you want to use `reactiveUmp()` directly, see [Signals — Solid](/adapters/signals/solid/).
...
- Choose [`@umpire/signals/solid`](/adapters/signals/solid/) when you want to work with `reactiveUmp()` directly.
