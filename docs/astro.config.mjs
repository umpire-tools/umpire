...
export default defineConfig({
  ...
  integrations: [
    ...
    starlight({
      ...
      customCss: ['./src/styles/custom.css', './src/styles/lineup.css', './src/styles/captcha-demo.css', './src/styles/signup-demo.css', './src/styles/react-demo.css', './src/styles/zustand-demo.css'],
      expressiveCode: {
        themes: ['github-dark'],
        styleOverrides: {
